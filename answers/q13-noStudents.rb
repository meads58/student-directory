#Q13 What happens if the user doesn't enter any students? It will try to print an empty list. How can you use an "if" statement (see pill control flow) to only print the list if there is at least one student in there?

#======
=begin
Added an 'if' statement into the print method to skip if there are no students to print.
